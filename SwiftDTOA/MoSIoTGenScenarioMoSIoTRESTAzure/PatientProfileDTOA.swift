...
class PatientProfileDTOA : DTOA
{
	...
	required init (fromJSONObject json: JSON)
	{
		...
		if (json["Diseases"] != JSON.null)
		{
			self.diseases = ConditionDTOA(fromJSONObject: json["Diseases"]);
		}
	...
	func toDictionary() -> [String : AnyObject]
	{
		...
		dictionary["Diseases"] = self.diseases?.toDictionary() ?? NSNull();
