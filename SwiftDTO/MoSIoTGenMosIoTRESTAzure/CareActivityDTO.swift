		...
		import SwiftyJSON
		 ...
		 class CareActivityDTO 	    {
				...
				var nextActivity_oid: Int?;
				    	 
		 
				var previousActivity_oid: Int?;
		   ...
		   
			{
				var dictionary: [String : AnyObject] = [:];
					...
					dictionary["nextActivity_oid"] = self.nextActivity_oid;
			

					dictionary["previousActivity_oid"] = self.previousActivity_oid;
