...
{
public class VitalSignAssemblerDTO {
public static IList<VitalSignEN> ConvertList (IList<VitalSignDTO> lista)
{
        IList<VitalSignEN> result = new List<VitalSignEN>();
        foreach (VitalSignDTO dto in lista) {
