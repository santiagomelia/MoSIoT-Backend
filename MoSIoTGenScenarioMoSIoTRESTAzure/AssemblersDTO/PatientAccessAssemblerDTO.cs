...
{
public class PatientAccessAssemblerDTO {
public static IList<PatientAccessEN> ConvertList (IList<PatientAccessDTO> lista)
{
        IList<PatientAccessEN> result = new List<PatientAccessEN>();
        foreach (PatientAccessDTO dto in lista) {
