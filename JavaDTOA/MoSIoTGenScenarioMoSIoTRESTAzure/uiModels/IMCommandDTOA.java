 ...
 */
public class IMCommandDTOA extends DTOA
{
	...
	public CommandDTOA getValueCommand () { return valueCommand; }
	public void setValueCommand (CommandDTOA valueCommand) { this.valueCommand = valueCommand; }
	...
	public void setFromJSON (JSONObject json)
	{
		try
		{
			...
			if (jsonValueCommand != null)
			{
				CommandDTOA tmp = new CommandDTOA();
				tmp.setFromJSON(jsonValueCommand);
				this.valueCommand = tmp;
			}
	...
	public JSONObject toJSON ()
	{
		...
		try
		{
		  ...
		  if (this.description != null)
			...
			{
				json.put("ValueCommand", this.valueCommand.toJSON());
			}
	...
	public IDTO toDTO ()
	{
		IMCommandDTO dto = new IMCommandDTO ();
	...
	dto.setDescription (this.getDescription());
		...
		// Roles
					// TODO: from DTOA [ ValueCommand ] (dataType : CommandDTOA) to DTO [ Command ]
