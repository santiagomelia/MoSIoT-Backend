...
public class CarePlanDTOA extends DTOA
{
	...
	public CarePlanTemplateDTOA getCarePlanTemplate () { return carePlanTemplate; }
	public void setCarePlanTemplate (CarePlanTemplateDTOA carePlanTemplate) { this.carePlanTemplate = carePlanTemplate; }
	...
	public void setFromJSON (JSONObject json)
	{
		try
		{
			...
			JSONObject jsonCarePlanTemplate = json.optJSONObject("CarePlanTemplate");
			if (jsonCarePlanTemplate != null)
			{
				CarePlanTemplateDTOA tmp = new CarePlanTemplateDTOA();
				tmp.setFromJSON(jsonCarePlanTemplate);
				this.carePlanTemplate = tmp;
			}
	...
	public JSONObject toJSON ()
	{
		...
		try
		{
		  ...
		  if (this.description != null)
			...
			{
				json.put("CarePlanTemplate", this.carePlanTemplate.toJSON());
			}
	...
	dto.setDescription (this.getDescription());
		...
		// Roles
					// TODO: from DTOA [ CarePlanTemplate ] (dataType : CarePlanTemplateDTOA) to DTO [ Template ]
