 ...
 */
public class RelatedPersonDTOA extends DTOA
{
	...
	public UserDTOA getRpData () { return rpData; }
	public void setRpData (UserDTOA rpData) { this.rpData = rpData; }
	...
	public void setFromJSON (JSONObject json)
	{
		try
		{
			...
			JSONObject jsonRpData = json.optJSONObject("RpData");
			if (jsonRpData != null)
			{
				UserDTOA tmp = new UserDTOA();
				tmp.setFromJSON(jsonRpData);
				this.rpData = tmp;
			}
	...
	public JSONObject toJSON ()
	{
		...
		try
		{
		  ...
		  if (this.description != null)
			...
			if (this.rpData != null)
			{
				json.put("RpData", this.rpData.toJSON());
			}
	...
	dto.setDescription (this.getDescription());
		...
		// Roles
					// TODO: from DTOA [ RpData ] (dataType : UserDTOA) to DTO [ UserRelatedPerson ]
