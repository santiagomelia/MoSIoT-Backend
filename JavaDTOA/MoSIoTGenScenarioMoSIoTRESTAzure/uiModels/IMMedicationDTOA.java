 ...
 */
public class IMMedicationDTOA extends DTOA
{
	...
	public MedicationDTOA getValueMedication () { return valueMedication; }
	public void setValueMedication (MedicationDTOA valueMedication) { this.valueMedication = valueMedication; }
	...
	public void setFromJSON (JSONObject json)
	{
		try
		{
			...
			if (jsonValueMedication != null)
			{
				MedicationDTOA tmp = new MedicationDTOA();
				tmp.setFromJSON(jsonValueMedication);
				this.valueMedication = tmp;
			}
	...
	public JSONObject toJSON ()
	{
		...
		try
		{
		  ...
		  if (this.value != null)
			...
			{
				json.put("ValueMedication", this.valueMedication.toJSON());
			}
	...
	public IDTO toDTO ()
	{
		IMMedicationDTO dto = new IMMedicationDTO ();
	...
	dto.setValue (this.getValue());
		...
		// Roles
					// TODO: from DTOA [ ValueMedication ] (dataType : MedicationDTOA) to DTO [ Medication ]
