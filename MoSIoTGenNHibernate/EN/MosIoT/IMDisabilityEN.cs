...
using System;
// Definición clase IMDisabilityEN
namespace MoSIoTGenNHibernate.EN.MosIoT
{
public partial class IMDisabilityEN                                                                 : MoSIoTGenNHibernate.EN.MosIoT.EntityAttributesEN
...
public IMDisabilityEN(IMDisabilityEN iMDisability)
{
        this.init (Id, iMDisability.Disability, iMDisability.Name, iMDisability.Type, iMDisability.IsOID, iMDisability.TargetAssociation, iMDisability.OriginAsociation, iMDisability.AssociationType, iMDisability.IsWritable, iMDisability.Description, iMDisability.Entity, iMDisability.Trigger, iMDisability.Register, iMDisability.Value);
}
...
public override bool Equals (object obj)
{
        if (obj == null)
                return false;
        IMDisabilityEN t = obj as IMDisabilityEN;
        if (t == null)
                return false;
        if (Id.Equals (t.Id))
                return true;
