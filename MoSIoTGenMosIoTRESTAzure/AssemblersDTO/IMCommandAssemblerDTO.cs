...
{
public class IMCommandAssemblerDTO {
public static IList<IMCommandEN> ConvertList (IList<IMCommandDTO> lista)
{
        IList<IMCommandEN> result = new List<IMCommandEN>();
        foreach (IMCommandDTO dto in lista) {
