...
{
public class IMMedicationAssemblerDTO {
public static IList<IMMedicationEN> ConvertList (IList<IMMedicationDTO> lista)
{
        IList<IMMedicationEN> result = new List<IMMedicationEN>();
        foreach (IMMedicationDTO dto in lista) {
