...
{
public class IMConditionAssemblerDTO {
public static IList<IMConditionEN> ConvertList (IList<IMConditionDTO> lista)
{
        IList<IMConditionEN> result = new List<IMConditionEN>();
        foreach (IMConditionDTO dto in lista) {
...
public static IMConditionEN Convert (IMConditionDTO dto)
{
        IMConditionEN newinstance = null;

        try
        {
                if (dto != null) {
                        newinstance = new IMConditionEN ();
