...
{
public class IMCommunicationAssemblerDTO {
public static IList<IMCommunicationEN> ConvertList (IList<IMCommunicationDTO> lista)
{
        IList<IMCommunicationEN> result = new List<IMCommunicationEN>();
        foreach (IMCommunicationDTO dto in lista) {
