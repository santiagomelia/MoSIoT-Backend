...
{
public class IMCareActivityAssemblerDTO {
public static IList<IMCareActivityEN> ConvertList (IList<IMCareActivityDTO> lista)
{
        IList<IMCareActivityEN> result = new List<IMCareActivityEN>();
        foreach (IMCareActivityDTO dto in lista) {
