...
{
public class IMTargetAssemblerDTO {
public static IList<IMTargetEN> ConvertList (IList<IMTargetDTO> lista)
{
        IList<IMTargetEN> result = new List<IMTargetEN>();
        foreach (IMTargetDTO dto in lista) {
...
public static IMTargetEN Convert (IMTargetDTO dto)
{
        IMTargetEN newinstance = null;

        try
        {
                if (dto != null) {
                        newinstance = new IMTargetEN ();
                        ...
                        if (dto.Target_oid != -1) {
                                ...
                                newinstance.Target = targetCAD.ReadOIDDefault (dto.Target_oid);
                        }
