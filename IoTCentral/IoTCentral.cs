...
namespace IoTCentral
{
    ...
    {
        private string _baseUrl = "https://mosiotalzheimer.azureiotcentral.com/api/preview";
        ...
        public async System.Threading.Tasks.Task<ApiTokenCollection> ListAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/apiTokens?api-version=1.0");
            ...
            else
            {
                try
                {
                    ...
                    using (var jsonTextReader = new Newtonsoft.Json.JsonTextReader(streamReader))
                    {
                        ...
                        System.Console.WriteLine("TypeBody en APIToken: " + typedBody); // ((JObject)typedBody)["value"][0]["roles"]

                        JsonCreator creator = new JsonCreator(jsonTextReader);
                        
             //           var obj = creator.ReadCompleteJson();

             //           System.Console.WriteLine("El objeto es: " + obj.ToString());
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    System.Console.WriteLine("ERROR DESERIALIZANDO TOKENS: Response " + response.Content);
    ...
    public partial class DeviceTemplatesClient 
    {
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/deviceTemplates?api-version=1.0");
        ...
        public async System.Threading.Tasks.Task<DeviceCollection> ListDevicesAsync(string device_template_id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/deviceTemplates/{device_template_id}/devices?api-version=1.0");
            urlBuilder_.Replace("{device_template_id}", System.Uri.EscapeDataString(ConvertToString(device_template_id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        protected virtual async System.Threading.Tasks.Task<ObjectResponseResult<T>> ReadObjectResponseAsync<T>(System.Net.Http.HttpResponseMessage response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers)
        {
            ...
            else
            {
                try
                {
                    ...
                    //    var serializer = Newtonsoft.Json.JsonSerializer.Create(JsonSerializerSettings);
                    //    var typedBody = serializer.Deserialize(jsonTextReader);
                    //    System.Console.WriteLine("TypeBody en DeviceTemplates: " + typedBody);
                    //}
                ...
                {
                    var message = "Could not deserialize the response body stream as " + typeof(T).FullName + ".";
                    System.Console.WriteLine("ERROR: Response " + response.Content);
                    throw new ApiException(message, (int)response.StatusCode, string.Empty, headers, exception);
                }
            }
        }
